...
from core.core_enums import ComponentType, Side, CreationMode
...
from maya_tools.utilities.boxy.boxy_data # boxy_sandbox.py
import logging
from importlib import reload
from maya import cmds
from pathlib import Path
...
if __name__ == "__main__":
    ...
    result = boxy_utils.create_polycube(
        pivot_side=Side.front,
        size=Point3(40, 15, 30))
