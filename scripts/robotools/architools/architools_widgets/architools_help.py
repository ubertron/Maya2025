...
from robotools.architools import TOOL_NAME, VERSIONS
...
FUNCTIONS = (
    ...
    "selected, rebuilds existing boxy nodes, converts architypes or meshboxes to boxy<br>"
    "&#8226; <b>Create Meshbox:</b> Context-sensitive meshbox creation - creates default meshbox if "
    "nothing selected, converts boxy/architypes to meshbox, recalculates existing meshboxes<br>"
    ...
    "Works on boxy nodes, meshboxes, and architypes - preserves size relative to axes<br>"
    "&#8226; <b>Help:</b> Display this help window<br><br>"
    "<b>General Attributes:</b><br>"
    "&#8226; <b>Default Cube Size:</b> Size used when creating boxy/meshbox with nothing selected<br>"
