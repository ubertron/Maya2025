...
from maya_tools.geometry_utils import get_vertex_position, set_vertex_position, get_vertex_positions, get_component_list
from maya_tools.node_utils import translate, rotate
...
def get_transform_and_selected_vertices(warn: bool = False):
    """
...
def align_selected_vertices(axis: int = 0, even_distribution: bool = False):
    ...
    """
    result = get_transform_and_selected_vertices()
